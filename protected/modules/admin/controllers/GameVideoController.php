...
class GameVideoController extends AController
{
	/**
...
//	public $layout='//layouts/column2';
	...
	{
		$model=new GameVideo('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['GameVideo']))
			$model->attributes=$_GET['GameVideo'];
	...
	{
		$model=GameVideo::model()->findByPk((int)$id);
		if($model===null)
